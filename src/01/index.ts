...
import { ZO_DEVNET_STATE_KEY, ZO_DEX_DEVNET_PROGRAM_ID, ZO_DEX_MAINNET_PROGRAM_ID, ZO_MAINNET_STATE_KEY } from "@zero_one/client";
...
export class Zo {
    ...
    public async loadMarginAccount(owner: PublicKey): Promise<zo.Margin> {
        return await zo.Margin.load(this.program, this.state, this.state.cache, owner);
    }
